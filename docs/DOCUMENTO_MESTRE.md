...
O estágio E adiciona, sem ligação ao runtime, repositories de Opportunity e Activity cujo ownership deriva de Client. Activity exige todo pai tenant-scoped e convergência semântica entre Client e Opportunity; órfãos, divergências e `tenantId=NULL` falham fechados. Inventário, matriz e rollback: [Sprint Brief](sprints/SPRINT_1_0B_2_E_TENANT_RELATIONAL_OWNERSHIP.md).
