...
assert.match(workflow, /preview-provenance[\s\S]*PREVIEW_RESOURCE_CLEANUP=ALREADY_ABSENT/, 'manifest must discover images after runtime resources disappear');
assert.match(workflow, /trusted_compose_files_missing/);
