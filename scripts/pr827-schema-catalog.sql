...
SELECT kind, name, detail FROM (
 ...
 UNION ALL SELECT 'column', table_name||'.'||column_name, is_nullable||':'||data_type FROM information_schema.columns WHERE table_schema='public' AND table_name='ErpOrderSync' AND column_name='supersedesErpOrderSyncId'
