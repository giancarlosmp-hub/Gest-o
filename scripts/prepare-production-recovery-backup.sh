...
checkpoint "PRODUCTION_BACKUP_AUTHORITATIVE_BUNDLE_ID=$PR827_BACKUP_RESOLVED_BUNDLE_ID"
checkpoint "PRODUCTION_BACKUP_PRODUCER_IDENTITY=$PR827_BACKUP_RESOLVED_IDENTITY"
